...
const mainMenuItems = [
  ...
  { 
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        <path d="M19 3H5C3.9 3 3 3.9 3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zm-7-2h2V7h-4v2h2v8z"/>
      </svg>
    ),
    submenu: [
      { name: 'CAD Översikt', path: '/cadviewer/overview' },
      { name: 'Sektionsvy', path: '/cadviewer/section' },
      { name: 'Detaljvy', path: '/cadviewer/detail' }
    ],
    collapsible: true
  },
  { 
