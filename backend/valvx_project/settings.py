"""
Django settings for valvx_project project.
"""
import os
...
ROOT_URLCONF = 'valvx_project.urls'
...
WSGI_APPLICATION = 'valvx_project.wsgi.application'
...
# Media files - viktigt för att kunna hitta uppladdade filer
MEDIA_URL = '/media/'
